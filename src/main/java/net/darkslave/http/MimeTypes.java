...
public class MimeTypes {
    ...
    public static String get(String filename) {
        String extension = extension(basename(filename));
        return cache.get(extension.toLowerCase());
    }


    /**
     * Установить соответствие расширения и mime-типа
     *
     * @param extension - расширение
     * @param mimeType  - mime-тип
     */
    public static void put(String extension, String mimeType) {
        cache.put(extension.toLowerCase(), mimeType);
    }
